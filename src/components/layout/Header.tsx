    ...
    <header className="site-header-pastel sticky top-0 z-[1000] w-full max-w-[100vw] overflow-visible backdrop-blur">
      <Container>
        <div className="flex min-h-20 items-center justify-between gap-3 py-2 sm:min-h-24 sm:gap-4 sm:py-3 lg:min-h-32">
          ...
          <details className="group relative z-[1000] lg:hidden">
            ...
            <div className="fixed inset-x-4 top-[6.25rem] z-[1000] max-h-[calc(100dvh-7rem)] overflow-auto rounded-medium border border-border-soft bg-[#fafcf9] p-4 shadow-soft sm:left-auto sm:right-6 sm:w-[22rem]">
              <NavigationLinks
