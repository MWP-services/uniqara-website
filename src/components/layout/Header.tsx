    ...
    <>
      ...
      {mobileMenuIsOpen ? (
        <div
          ...
          className="fixed inset-x-4 top-[6.25rem] z-[9999] max-h-[calc(100dvh-7rem)] overflow-auto rounded-medium border border-border-soft bg-[#fafcf9] p-4 shadow-soft sm:left-auto sm:right-6 sm:w-[22rem] lg:hidden"
